      ...
      <main className="container py-6 pb-24 md:pb-8">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            <div className="relative aspect-[9/16] overflow-hidden rounded-xl bg-secondary/30 border border-border max-w-md mx-auto">
              {allImages.length > 0 && !imageError ? (
                ...
                <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-primary/5 to-primary/10">
                  <div className="text-center">
                    <Smartphone className="h-20 w-20 text-primary/40 mx-auto mb-3" />
          ...
          <div className="space-y-6">
            ...
            {/* Specs - Made smaller and more compact */}
            <div className={`grid ${gridCols} gap-3`}>
              <div className="rounded-lg border border-border bg-card p-2.5 text-center">
                <HardDrive className="h-4 w-4 text-primary mx-auto mb-1" />
                <p className="text-xs text-muted-foreground">Xotira</p>
                <p className="text-sm font-semibold text-foreground">{phone.storage}</p>
              </div>
              <div className="rounded-lg border border-border bg-card p-2.5 text-center">
                <CheckCircle className="h-4 w-4 text-primary mx-auto mb-1" />
                <p className="text-xs text-muted-foreground">Holati</p>
                <p className="text-sm font-semibold text-foreground">{conditionLabel}</p>
              </div>
              <div className="rounded-lg border border-border bg-card p-2.5 text-center">
                <MapPin className="h-4 w-4 text-primary mx-auto mb-1" />
                <p className="text-xs text-muted-foreground">Shahar</p>
                <p className="text-sm font-semibold text-foreground">{phone.city}</p>
              </div>
              {showBattery && (
                <div className="rounded-lg border border-border bg-card p-2.5 text-center">
                  <Battery className="h-4 w-4 text-green-500 mx-auto mb-1" />
                  <p className="text-xs text-muted-foreground">Batareyka</p>
                  <p className="text-sm font-semibold text-foreground">{phone.battery_health}%</p>
                </div>
              )}
            </div>
